...
fn key_description(key: &str) -> Option<(&'static str, &'static str)> {
    match key {
        ...
        "LEFT" | "LEFT_ARROW" => Some(("Left Arrow", "Moves cursor left.")),
        "RIGHT" | "RIGHT_ARROW" => Some(("Right Arrow", "Moves cursor right.")),
        "UP" | "UP_ARROW" => Some(("Up Arrow", "Moves cursor up.")),
        "DOWN" | "DOWN_ARROW" => Some(("Down Arrow", "Moves cursor down.")),
        ...
        "KP_SLASH" | "KP_DIVIDE" => Some(("Keypad /", "Keypad division.")),
