...
- fix(install,dev): preserve unmanaged plugin target before rsync install; hard-refuse symlinked targets and make backup failures fatal

## [1.2.5] - 2026-09-23

### Added

- feat(ui): animated dots during native-helper install; show Installing immediately

### Changed

- build(gitignore): ignore release tarballs in repo root
